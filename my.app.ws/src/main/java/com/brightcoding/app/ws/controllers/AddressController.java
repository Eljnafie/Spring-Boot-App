...
public class AddressController {
	...
	public ResponseEntity<AddressResponse> StoreAddresse(@RequestBody AddressRequest addressResquest,
			Principal principal) {

		ModelMapper modelMapper = new ModelMapper();

		AddressDto addressDto = modelMapper.map(addressResquest, AddressDto.class);
	...
	public ResponseEntity<AddressResponse> updateAddresse(@PathVariable(name = "id") String addressId, @RequestBody AddressRequest addressRequest ){

	ModelMapper modelMapper = new ModelMapper();
	
	AddressDto addressDto = modelMapper.map(addressRequest, AddressDto.class);

	AddressDto updateAdress = addressService.updateAddress(addressId, addressDto);

	AddressResponse addressResponse = modelMapper.map(updateAdress, AddressResponse.class);
